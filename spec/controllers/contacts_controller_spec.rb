...
RSpec.describe ContactsController, type: :controller do
  ...
  let(:valid_attributes) {
    {nom:"arf", prenom:"toto", email:"arf.toot@gmail.com", image: fixture_file_upload("rails.png", 'image/png')}
  }

  let(:invalid_attributes) {
    {nom:"arf", prenom:nil, email:nil, image:nil}
  }

  # This should return the minimal set of values that should be in the session
  # in order to pass any filters (e.g. authentication) defined in
  # ContactsController. Be sure to keep this updated too.
  let(:valid_session) { {id:"arf"} }
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        {nom:"lol", prenom:"titi", email:"titi.lol.gmail.com", image: fixture_file_upload("rails.png", 'image/png')}
      }
